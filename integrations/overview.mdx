...
After you connect an integration, its slug is shown in your workspace's
integration settings alongside the connection's display name. Copy it verbatim
into the `source` field of your triggers.
