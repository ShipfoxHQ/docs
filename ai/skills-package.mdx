---
title: "Shipfox Skills Package for AI Coding Agents"
sidebarTitle: "Skills Package"
description: "Install the Shipfox skills package to give Claude Code, Cursor, Codex, and 18+ other coding agents the full workflow schema, hard rules, and correct examples."
---
...
- The today/roadmap boundary, explicitly listing what NOT to use: `loop`, `matrix`, `${{ }}` interpolation, and `branch`
...
| **Stays current** | Auto-updates with schema | Must re-paste after schema changes |
...
<Tip>
  The skills package is generated from the Shipfox workflow schema source — it tracks schema changes automatically. You don't need to update it manually.
</Tip>
