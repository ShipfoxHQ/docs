...
- Labels are set when you start the runner process, typically as a comma-separated argument or environment variable. Refer to the runner setup instructions in Settings → Runners for the exact flags your version accepts.
