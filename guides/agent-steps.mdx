---
title: "Add AI Agent Steps to Your Shipfox Workflows"
sidebarTitle: "Agent Steps"
description: "Use Shipfox agent steps to run AI models inline in your workflows. Configure model, thinking level, provider, and gate conditions to control agent behavior."
---
...
The optional `name` field labels the step in the dashboard and is required if you want to reference the step in a `restart_from` gate.
