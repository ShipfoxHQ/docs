---
title: "Run Checks on Every GitHub Push with Shipfox"
sidebarTitle: "Checks on Push"
description: "Set up a Shipfox workflow that runs tests, lint, and an AI review step automatically on every push to your GitHub repository."
---
...
When lint and tests are independent, running them in parallel cuts wall-clock time. Remove the `needs` relationship between them and let both start immediately, then fan in to the `review` job once both finish:
