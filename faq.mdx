...
<AccordionGroup>
  ...
  <Accordion title="Is self-hosting supported?">
    Yes. Shipfox requires PostgreSQL, Temporal, and S3-compatible object storage. The runner is a separate process you deploy on your compute. See the [Installation guide](/installation) for details. Managed hosting is also available.
  </Accordion>
