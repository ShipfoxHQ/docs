...
<AccordionGroup>
  ...
  <Accordion title="How do I run Shipfox locally to test?">
    Use the Docker Compose evaluation stack. See [Local Evaluation](/installation/local) for step-by-step instructions. Note that push triggers don't fire locally — use manual triggers for local testing.
  </Accordion>
  ...
  <Accordion title="Is self-hosting supported?">
    Yes. Shipfox requires PostgreSQL, a workflow orchestration service, and S3-compatible object storage. The runner is a separate process you deploy on your compute. See [Self-Hosting](/installation/self-hosting) for details. Managed hosting is also available.
  </Accordion>
