...
<AccordionGroup>
  ...
  <Accordion title="How do I run Shipfox locally to test?">
    Use the Docker Compose evaluation stack. See [Local Evaluation](/installation/local) for step-by-step instructions. GitHub push triggers don't fire locally, but the stack includes a local Gitea whose push events do — see the local guide for the trigger to use.
  </Accordion>
